...
struct search : public search_plan_impl<DATASET_DESCRIPTOR_T, SAMPLE_FILTER_T> {
  ...
  void operator()(
    ...
    typename DATASET_DESCRIPTOR_T::INDEX_T* const data_indices_ptr,       // [num_queries, topk]
    typename DATASET_DESCRIPTOR_T::DISTANCE_T* const data_distances_ptr  // [num_queries, topk]
    //두개는 임시입니다. single cta만 사용해요.
    )
  {
